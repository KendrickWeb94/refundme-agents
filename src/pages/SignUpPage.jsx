...
const SignUpPage = () => {
    ...
    const [formData, setFormData] = useState({
        fullName: "", email: "", password: "", role: "agent", location: ""
    });
    ...
    const validateForm = () => {
        ...
        if (!formData.location.trim()) return toast.error("Your location is required");
    ...
    return (<div className="h-full  grid lg:grid-cols-2">
        {/* left side */}
                ...
                <form onSubmit={handleSubmit} className="space-y-4">
                    ...
                    <div className="form-control">
                        <div className="relative">
                            ...
                            {/*{loading && (<div className="absolute right-2 top-[38px]">*/}
                            {/*        <Loader2 className="size-5 animate-spin"/>*/}
                            {/*    </div>)}*/}
                        </div>
                    </div>

                    <button type="submit" className=" bg-primary text-white px-4 py-2 text-sm rounded-md w-full"
